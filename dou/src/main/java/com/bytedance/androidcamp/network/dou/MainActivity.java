...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        new AsyncTask<Object, Integer, String>() {
            ...
            protected String doInBackground(Object... objects) {
                try {
                    PostVideoResponse postVideoResponse = getMiniDouyinService().postVideo("3170105369", "shenmishajing", coverImagePart, videoPart).execute().body();
                    return postVideoResponse.getUrl();
                } catch (IOException e) {
                    e.printStackTrace();
    ...
    public void fetchFeed(View view) {
        ...
        new AsyncTask<Object, Integer, String>() {
            @Override
            protected String doInBackground(Object... objects) {
                GetVideoResponse getVideoResponse = null;
                try {
                    getVideoResponse = getMiniDouyinService().getVideos().execute().body();
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                if (s != null) Toast.makeText(MainActivity.this, s, Toast.LENGTH_SHORT).show();
                initRecyclerView();
